...
#🧠 在同一個生命週期函式下，事件處理、Promise、setTimeOut下都夾雜著多個狀態更新指令，請問Batching會合併處理嗎？為什麼? ->->-> `並不會，只會在同一個生命週期中，讓事件處理、Promise、setTimeOut各自處理自己的Batching`
<!--SR:!2022-08-25,3,250-->


#🧠 在同一個生命週期函式下，那麼如果發生多個事件處理來處理，會如何處理batching？ 全部事件處理都算在一塊做batching? ->->-> `多個事件處理中的每個事件處理都自行做自己內部的batching`
<!--SR:!2022-08-25,3,250-->
