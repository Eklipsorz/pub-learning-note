...
#🧠 React：Dependencies 設定主要目的是效能最佳化，若排除的話，它還能做什麼？ ->->-> `單純解決邏輯上控制，比如解決擁有能夠觸發渲染的side effect所引起的無限迴圈問題`

#🧠 React：Dependencies 設定主要目的是效能最佳化，若排除的話，它還能做單純解決邏輯上控制，舉例來說會是？？ ->->-> `比如解決擁有能夠觸發渲染的side effect所引起的無限迴圈問題`
