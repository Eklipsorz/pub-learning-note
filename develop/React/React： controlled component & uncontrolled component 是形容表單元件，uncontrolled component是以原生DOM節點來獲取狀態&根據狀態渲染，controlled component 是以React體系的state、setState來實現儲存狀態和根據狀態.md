...
#🧠 React ：對於uncontrolled component，會有一些方法來獲取資訊和渲染，具體能夠對該component本身做什麼來實現？->->-> `獲取狀態 & 儲存狀態：擷取對應的DOM節點，並從節點中取得資訊來儲存、渲染：從React的開發角度觸發原生元件的渲染，讓其根據狀態去渲染自己元件`
<!--SR:!2022-08-29,3,250-->
