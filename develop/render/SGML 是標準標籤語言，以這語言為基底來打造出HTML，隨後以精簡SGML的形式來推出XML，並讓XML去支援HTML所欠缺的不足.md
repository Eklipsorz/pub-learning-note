...
- 由於XHTML的語法本身會區分大小寫，必須以小寫來描述每個標籤和屬性
...
#🧠 原本HTML本身不區分大小寫，那HTML 上的語法為何皆以小寫為主？ ->->-> `- 現今HTML 本身支援著XHTML、基於SGML的HTML、DOM的標籤語言 - 由於XHTML的語法本身會區分大小寫，必須以小寫來描述每個標籤和屬性 - HTML為了能夠與XHTML無縫接軌：使HTML轉變成XHTML來處理，或者使XHTML轉變成HTML來處理，所以普遍要求開發者都以小寫來寫HTML語法`
