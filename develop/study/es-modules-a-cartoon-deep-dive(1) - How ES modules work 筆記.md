...
<!--SR:!2023-05-05,148,228-->


#🧠 ES module 以建構來舉例非同步的任務如何做？(以理論來說) ->->-> `瀏覽器會生成多個thread來同時向模組所在的主機(位置)發送請求索要對應模組，不同模組下的任務可以不必相互等待不同模組的任務，但對於同個模組的任務：下載->解析->建立關係圖會是同步的`
<!--SR:!2023-07-19,213,247-->
