...
重點：
- OAuth 概念 的 基本實現會有的流程：當使用者要授權給A來獲取Resource Server的服務時
...
- 在這裡 **使用者同意並給予授權資料至應用程式A** 由於Resource Server/Authorization Server無法識別出該授權資料會是合法的使用者提供的？以及其內容是否合法？，所以會因這點而衍生以下授權方式
